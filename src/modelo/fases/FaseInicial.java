...
public class FaseInicial implements Fase {
    ...
    @Override
    public void ponerCartaEnLaMano(Jugador jugadorActivo) throws MazoVacioException, CartaAlGoOhInexistenteException, MazoLlenoException {
        jugadorActivo.ponerCartaEnLaMano();
    }
